    ...
    <div className="WhyWork">
      ...
      <div>
        <div>
          ...
          <p>
            Working with Alacrity means being part of a mission bigger than just
            a paycheck. You&#8217;ll be providing care to the men and women who
            dedicate their lives to protecting our country, ensuring they
            receive the highest quality care possible. Your work will directly
            impact the lives of those who have made countless sacrifices for our
            freedom.
          </p>
        </div>
        <div>
          ...
          <p>
            ...
            and resources to help you succeed. Our team is always here to ensure
            you have the tools you need to provide the best care possible.
          </p>
        </div>
        <div>
          <Image
